...
//npm install moment para importar moment

//importe moment para capturar la fecha y hora
...
// A) '/' en esta ruta raíz, el servidor enviará string con un elemento de título 
//nivel 1 (un h1 en formato HTML) que contenga el mensaje: 'Bienvenidos al servidor express' en color azul.
app.get('/', (req, res) => {
    res.send('<h1 style=color:blue>Bienvenidos al servidor express</h1>');
});


// B) '/visitas' donde con cada request, el servidor devolverá un mensaje 
//con la cantidad de visitas que se hayan realizado a este endpoint. Por ej. 'La cantidad de visitas es 10'
let visitas = 0;
...
app.get('/fyh', (req, res) => {
    ...
    const today = moment();
    res.send({ fyh: today.format('DD/MM/YYYY HH:mm:ss') })
